...
<head>
        <!--=============== basic  ===============-->
        <meta charset="UTF-8">
        <title>structured cabling | Kohan it</title>
                            ...
                            <div class="nav-container fl-wrap" >
                                ...
                                <nav class="nav-inner" id="menu">
                                    <ul>
                                        ...
                                        <li><a href="structured_cabling.php"class="custom-scroll-link act-link">Structured Cabling</a></li>
                                        <li>
                        ...
                        <div class="row align-items-center">
                            <div class="col-lg-5 col-md-7 d-md-block d-none py-2">
                                <div class="banner-img">
                                    <img src="assets/assets3/images/<?php echo $row_page['content1']; ?>" class="banner-img-left" alt>
                            ...
                            <div class="col-lg-7 col-md-5 col-12">
                                <div class="banner-content mobile-bg1">
                                    <img src="assets/assets3/images/banner/banner-bg-text.png" class="banner-text-bg" alt>
                           
                                    <h1><?php echo $row_page['content2']; ?></h1><p><?php echo $row_page['content3']; ?></p>
    ...
    <div class="service-section pt-120">
        <div class="container position-relative">
            ...
            <img src="assets/assets3/images/icon/dot-frame.svg" class="dotted-frame" alt>
            ...
            <div class="row d-flex justify-content-center g-4">
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-8 order-1 wow animate fadeInDown" data-wow-duration="1.5s"
                    data-wow-delay="0.7s">
                    <div
                        class="service-item hover-btn service-mt-30 d-flex flex-row align-items-center justify-content-between">
                        <div class="s-content">
                            <div class="number">01</div>
                            <h4><a href="service-details.html">Site  <br> Assessment</a></h4>
                        </div>
                        <span></span>
                        <div class="s-icon">
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-8 order-1 wow animate fadeInDown" data-wow-duration="1.5s"
                    ...
                    <div class="service-item hover-btn d-flex flex-row align-items-center justify-content-between">
                        <div class="s-content">
                            ...
                            <h4><a href="service-details.html">Engineer  <br> Solution</a></h4>
                        </div>
                        <span></span>
                        <div class="s-icon">
                ...
                <div class="col-xl-4 col-lg-4 col-md-8 col-sm-8 order-lg-1 order-0">
                    <div class="section-card all-service-card2 wow animate fadeInDown" data-wow-duration="1.5s"
                        data-wow-delay="0.5s">
                        <h2>Our Services</h2>
                        <a href="contacts.php" class="eg-btn hover-btn sectoin-card-btn"><span>Contact Now <img
                                    src="assets/assets3/images/icon/arrow-servc.svg" alt></span></a>
                    </div>
                </div>
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-8 order-1 wow animate fadeInDown" data-wow-duration="1.5s"
                    data-wow-delay="0.8s">
                    <div class="service-item hover-btn d-flex flex-row align-items-center justify-content-between">
                        <div class="s-content">
                            ...
                            <h4><a href="#">Install <br>  Cabling</a></h4>
                        </div>
                        <span></span>
                        <div class="s-icon">
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-8 order-1 wow animate fadeInDown" data-wow-duration="1.5s"
                    data-wow-delay="0.9s">
                    <div
                        class="service-item hover-btn mt-minus30 d-flex flex-row align-items-center justify-content-between">
                        <div class="s-content">
            ...
            <div class="row g-4 d-flex justify-content-center">
                <div class="col-lg-6 col-md-8 col-sm-8 order-1">
                    <div class="about-img wow animate fadeInDown" data-wow-duration="1.5s" data-wow-delay="0.5s">
                        ...
                        <img src="assets/assets3/images/<?php echo $row_page['content4']; ?>" alt>
                    </div>
                </div>
                ...
                <div class="col-lg-6 col-md-8 col-sm-8 col-sm-8 order-md-4 order-3">
                    <div class="about-img wow animate fadeInUp" data-wow-duration="1.5s" data-wow-delay="0.5s">
                        <img src="assets/assets3/images/<?php echo $row_page['content9']; ?>" alt>
                    </div>
                </div>
            ...
            <div class="row g-4 d-flex justify-content-center">
                <div class="col-lg-6 col-md-8 col-sm-8 order-1">
                    <div class="about-img wow animate fadeInDown" data-wow-duration="1.5s" data-wow-delay="0.5s">
                        ...
                        <img src="assets/assets3/images/<?php echo $row_page['content10']; ?>"  alt>
                    </div>
                </div>
                <div class="col-lg-6 col-md-8 col-sm-8 order-2">
                    <div class="about-card wow animate fadeInDown" data-wow-duration="1.5s" data-wow-delay="0.5s">
                ...
                <div class="row justify-content-center align-items-center">
                    ...
                    <div class="col-lg-4 col-md-5 col-sm-8">
                        <div class="video-area">
                            ...
                            <img src="assets/assets3/images/<?php echo $row_page['content13']; ?>" alt>
                        </div>
