...
?>
<?php 
$pagetitle = "Low Voltage System page settings :: All Pages Settings"; 
$currentpage = "allpage"; 
$formactionurl = "low_voltage_system_page_server.php";
?>
<?php 
            ...
            <div class="col-md-12">
                <div class="card border-0 mb-4 no-bg">
                    <div class="card-header py-3 px-0 d-flex align-items-center  justify-content-between border-bottom">
                        <h3 class=" fw-bold flex-fill mb-0">Update Low Voltage System page</h3>
            ...
            <div class="tab-content profile-tab" id="myTabContent">
                <div class="tab-pane fade show active" id="tab1" role="tabpanel" aria-labelledby="home-tab">
                    ...
                    <div class="container mt-3">
                        ...
                        <div class="fl-wrap d-flex justify-content-between">
                            <div class="w-30">
                                <img src="../assets/assets4/images/<?php echo $row_page['content3']; ?>" class="w-100" alt=""
                                    srcset="">
                            </div>
                            <div class="w-70">
                                <form action="<?php echo $formactionurl; ?>" method="POST" enctype="multipart/form-data">
                                    <div class="input-group">
                                        ...
                                        <input type="file" class="form-control" name="img[content3]" id="image-input-file1" multiple>
                                    </div>
                            ...
                            <h2><?php echo $row_page['content1']; ?></h2>
                ...
                <div class="tab-pane fade" id="tab2" role="tabpanel" aria-labelledby="profile-tab">
                    ...
                    <div class="container mt-3">
                        ...
                        <div class="fl-wrap d-flex justify-content-between">
                            <div class="w-30">
                                <img src="../assets/assets4/images/<?php echo $row_page['content4']; ?>" class="w-100" alt=""
                                    srcset="">
                            </div>
                            <div class="w-70">
                                <form action="<?php echo $formactionurl; ?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="tab-pane fade show" id="tab5" role="tabpanel" aria-labelledby="home-tab">
                    ...
                    <div class="container mt-3">
                        ...
                        <div class="fl-wrap d-flex justify-content-between">
                            <div class="w-30">
                                <img src="../assets/assets4/images/<?php echo $row_page['content13']; ?>" class="w-100" alt=""
                                    srcset="">
                            </div>
                            <div class="w-70">
                                <form action="<?php echo $formactionurl; ?>" method="POST" enctype="multipart/form-data">
